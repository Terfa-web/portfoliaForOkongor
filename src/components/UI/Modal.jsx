...
const Modal = ({ activeID, setShownModal }) => {
  ...
  return (
    <div className="w-full h-full fixed top-0 z-10 bg-headingColor bg-opacity-40">
      <div className="w-11/12 md:max-w-[600px] md:w-full absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform -translate-x-1/2 -translate-y-1/2 p-5">
        ...
        <div>
          <h2 className=" m-6 text-2xl text-headingColor font-[700]">
            {portfolio.title}
          </h2>

          <p className="text-[18px] leading-7 text-smallTextColor">
            {portfolio.description}
          </p>

          <div className="mt-5 flex items-center gap-3 flex-wrap">
            <h4 className="text-headingColor text-[20px] text-[700]">
              Technologies:
            </h4>
          ...
          <a href="https://vercel.com/terfas-projects">
